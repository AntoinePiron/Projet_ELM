...
var $author$project$MyParser$Point = F2(
	function (x, y) {
		return {x: x, y: y};
	});
...
var $author$project$MyParser$point = A2(
	...
	A2(
		...
		A2(
			...
			A2(
				$elm$parser$Parser$ignorer,
				$elm$parser$Parser$succeed($author$project$MyParser$Point),
...
var $author$project$Main$parse = function (string) {
	return A2($elm$parser$Parser$run, $author$project$MyParser$point, string);
};
	...
	function (msg, model) {
		if (msg.$ === 'Change') {
			...
			return _Utils_update(
				...
				{
					display: function () {
						var _v1 = $author$project$Main$parse(model.content);
						if (_v1.$ === 'Err') {
							return 'Parse failed';
						} else {
							var expr = _v1.a;
